...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="CSS/league22.css">
...
<p><a href="logout.php">Log out</a></p>
      ...
      <?php 
			...
			if($result->num_rows>0)
		{
			...
			while($row=mysqli_fetch_array($result))
			{
              ...
              if($brojac<8){
                if($brojac%2===0){
                  echo "<td class=\"blue2\">"; echo $brojac; echo ".</td>";
                }else{
                  echo "<td class=\"blue1\">"; echo $brojac; echo ".</td>";
                }
              }else{
    ...
    <div class="poruka">
        Teams on positions from 1 to 7 - promotion at the end of sesason to the League 1. <br>
        <?php
          if($pos!==null){
