...
$sql = "SELECT * FROM players WHERE id = $teamId";
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-0"method="post" action="pretraga.php">
        ...
        <div class = "op">
          ...
          ?>
             <form action="igracF.php" method="POST">
             <div>
               <label for="linkInput" class="ime">Player's mark:</label>
               <br/>
               <!--<input type="text" name="link" id="linkInput" placeholder="Insert link for players...">-->
               <input type="number" name="link" style="width:100%; height: 40px; background-color: white;" value=<?=$club["mark"]?>>
               <input type="hidden" name="team_id" value=<?=$teamId?>>
               <input type="hidden" name="teamD_id" value=<?=$club["club"]?>>
            </div>
          <br/>
